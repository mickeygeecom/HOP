...
function createQuiz(name, description) {
    fetch('https://localhost/api/admin/quizzes', {
        method: 'POST',
        headers: {
...
function editQuiz(quizId) {
    ...
    fetch(`https://localhost/api/admin/quizzes/${quizId}`, {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json',
        },
...
function showQuestions(quizId) {
    ...
    fetch(`https://localhost/api/admin/quizzes/${quizId}/questions`)
    .then(response => response.json())
    .then(data => {
...
function editQuestion(quizId, questionId) {
    fetch(`https://localhost/api/admin/questions/${questionId}`)
    .then(response => {
        if (!response.ok) {
